ready = ->
  ...
  update = ((source)->
    ...
    nodeEnter.append('circle').attr('r', 1e-6)
      .style('fill', (d)-> if d._children then return 'lightsteelblue' else return '#fff' )

    nodeEnter.append('text')
      .attr('x', (d)-> if d.children or d._children then return -10 else return 10)
      .attr('dy', '.35em')
      .attr('text-anchor', (d)-> if d.children or d._children then return 'end' else return 'start')
      .text((d)-> d.name )
